...
Right now, the team is working on a new process for getting good first tasks
into the hands of new community members. While we're in this transition period,
please visit the `Contributing to the Open edX codebase wiki page`_.

.. _Contributing to the Open edX codebase wiki page: https://openedx.atlassian.net/wiki/spaces/COMM/pages/941457737/How+to+start+contributing+to+the+Open+edX+code+base
...
Please fill out the survey posted on your pull request once it is closed. If you
have specific praise, or constructive criticism you think the community could
benefit from, please post on the `forums`_.
