...
On the edX Edge site, you can use Studio to build your own courses.
...
When you receive notice that you can create courses on Edge, log in to Studio_.
...
You can also go directly to the `edX Edge`_ LMS. Sign in if prompted. You see
the course you just created listed on your **My Courses** dashboard.
...
run courses on the edx.org website. Only edX staff members can create courses
to run on edx.org. After the course is created, you can add content in Studio,
and then view it  in the LMS.

To see the content of your course as learners will see it, you must enroll in
your course. You can then view it on the LMS.

#. In Studio, verify that your course was created and add content.
