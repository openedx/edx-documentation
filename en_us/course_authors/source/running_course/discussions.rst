...
For details about creating discussion topics, see :ref:`Create ContentSpecific
Discussion Topics` and :ref:`Create CourseWide Discussion Topics`. For details
about configuring discussion topics in courses with cohorts enabled, see
