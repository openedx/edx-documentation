...
.. note:: Content libraries are available only with courses whose course
...
#. Enter the required information for your new library, then click **Create**.
   ...
   .. note:: Enter new library information carefully. After you create a
      new library, you cannot delete it. The Library Code becomes part of the
      URL for your library, therefore the total number of characters in the
      **Library Name**, **Organization**, and **Library Code** fields must be 65
      or fewer.
...
.. note:: Only library users with **Admin** level of access can add users to
   the library. 
...
the **Staff** level of access. You can give **Admin** level of access only to
people who already have the **Staff** level of access.
...
#. On the **User Access** page, locate the user to whom you are giving
  ...
  - If he is currently has **Staff** access, click **Add Admin Access**.
