...
certificates, which are awarded to learners when they complete a course.
...
.. list-table::
   ...
   * - ``generation_mode``
     - string
     - Indicates whether this certificate was generated as a result of a batch
       or individual command.
   * - ``user_id``
     - integer
...
.. list-table::
   ...
   * - ``source_url``
     ...
     - The URL of the web site where the certificate evidence link was
       clicked. This URL is the same as the HTTP_Referer URL.
