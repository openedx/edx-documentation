...
courses. The edX data package contains data only about one institution's
courses; an RDX data package can contain data about courses from other partner
institutions that also participate in the RDX program.
