...
#. Open a **Content Area** page, and from the **Build Content** menu select
   **Web Link**.
   ...
   .. image:: ../../../../shared/building_and_running_chapters/Images/lti_blackboard_contentarea.png
...
#. On the **Create Web Link** page, enter an identifying name and the URL for
   ...
   .. image:: ../../../../shared/building_and_running_chapters/Images/lti_blackboard_create_link.png
...
#. Review the content to verify that it appears as you expect.
   ...
   .. image:: ../../../../shared/building_and_running_chapters/Images/lti_blackboard_example.png
