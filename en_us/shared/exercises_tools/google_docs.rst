...
#. From the **File** menu, select **Publish to the web**.
   ...
   .. image:: ../../../shared/building_running_course/Images/google-publish-to-web.png
    :alt: The Google Drive file Publish to the web dialog box

#. Click **Publish**, then select **OK** to confirm the action.
#. Click the **Embed** tab.
      
   .. image:: ../../../shared/building_running_course/Images/google-embed.png
...
#. Under **Add New Component** click **Advanced**, and then select **Google
   ...
   .. image:: ../../../shared/building_running_course/Images/google-document-studio.png
    :alt: The Google Drive file component in a unit page

#. In the new component, select **Edit**.
   
   .. image:: ../../../shared/building_running_course/Images/google-document-edit-studio.png
