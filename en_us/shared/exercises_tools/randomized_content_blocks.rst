...
#. Click **Save Changes**. 
  ...
  .. image:: ../../../shared/building_running_course/Images/ContentLibraries_AdvancedSetting.png
...
#. In the randomized content block settings, specify the details of the content
  ...
  - For **Problem Type**, from the drop down list select a specific type of
    ...
    .. image:: ../../../shared/building_running_course/Images/ContentLibraries_SelectProblemType.png
...
#. In the randomized content block, click the **View** icon.
   ...
   .. image:: ../../../shared/building_running_course/Images/ContentLibraries_ViewMatching.png
...
a **Clear** icon is shown next to the setting field.
 ...
 .. image:: ../../../shared/building_running_course/Images/ContentLibraries_ResetComponentField.png
...
* If the components in the randomized content block have not been edited in the
  ...
  .. image:: ../../../shared/building_running_course/Images/ContentLibraries_ComponentUpdateNow.png
