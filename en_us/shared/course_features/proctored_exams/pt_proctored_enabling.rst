...
To create a proctored exam, you modify the advanced settings of the course in
Studio to enable proctored exams, and then you modify the settings of a
subsection to specify that the subsection is a proctored exam.
