...
Updated the :ref:`learners:Certificates` topic to include information about web certificates.
...
* Added the :ref:`opencoursestaff:Using edX as an LTI Tool Provider`
  section.
