...
edX instances, and offers a data migration and a set of post-migration options.
This change will be released to the edx-platform repository on TBD, and will
affect all Open edX installations that follow master on that date.
...
options before you choose an option for your Open edX installation.
